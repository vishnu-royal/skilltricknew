      ...
      <div className="container-fluid p-0">
        <div className="row">
          ...
          <div className="col-lg-6">
            ...
            <div className="flex-grow d-flex flex-md-column align-items-md-center justify-content-md-center w-md-50">
              <div className="w-100 px-4 text-center text-extra-small w-lg-50">
                <div className="container-tight">
                  ...
                  <div className="my-3 d-flex align-items-center gap-3 text-black opacity-60">
                    <span
                  ...
                  <form className="w-100 form-section">
                    <div className="row gx-2">
                        ...
                        <div className="form-group position-relative">
                          ...
                          <div className="position-relative">
                            ...
                            <span
                              ...
                              onClick={() =>
                                togglePassword("password", "eye-icon1")
                              }
                            >
                              <i id="eye-icon1" className="fas fa-eye"></i>
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-md-12">
                        <div className="form-group position-relative">
                          ...
                          <div className="position-relative">
                            ...
                            >
                              <i id="eye-icon2" className="fas fa-eye"></i>
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-md-12">
                        <button
                          className="btn btn-md btn-blue mt-2"
                          type="submit"
                        >
                          Sign up
                        </button>
